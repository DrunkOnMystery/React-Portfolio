    ...
    return (
        <div className="BodyPortfolio">
            <main class="card-container">
                <div class="row">
                    <div class="card">
                        <a target="_blank" href="https://tintin92.github.io/MovieDine/"><img
                        ...
                        <div class="card-body">
                            ...
                            search for streaming film
                                and tv option and also find local restaurants. <a target="_blank"
                                    href="https://github.com/DrunkOnMystery/MovieDine">Github here.</a></p>
                        </div>
                    </div>
                    <div class="card">
                        <a target="_blank" href="http://mega-awesome.herokuapp.com/"><img
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A group project in which we created an interactive and searchable database in mysql of UFO sightings. <a target="_blank"
                                href="https://github.com/DrunkOnMystery/alientown">Github here.</a></p>
                        </div>
                    </div>
                    <div class="card">
                        <a target="_blank" href="https://drunkonmystery.github.io/Day-Planner/"><img src="assets/DayPlanner.PNG"
                        ...
                        time. <a target="_blank" href="https://github.com/DrunkOnMystery/Day-Planner">Github
                            here.</a></p>

                        </div>
                    </div>
                    <div class="card">
                        <a target="_blank" href="https://drunkonmystery.github.io/Weather-Dashboard/?"><img
                        ...
                        <div class="card-body">
                            ...
                            using APIs. <a target="_blank"
                                    href="https://github.com/DrunkOnMystery/Weather-Dashboard">Github here.</a></p>
                        </div>
                    </div>
                    <div class="card">
                        <a target="_blank" href="https://drive.google.com/file/d/1tOCY3EAFUWTDcYQWsJ7gIVr6pXem4dR-/view"><img
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A Javascript application designed to automate and streamline the process of creating ReadMe files for projects on Github.<a target="_blank"
                                href="https://github.com/DrunkOnMystery/README_Generator">Github here.</a></p>
                        </div>
                    </div>
                    <div class="card">
                        <a target="_blank" href="https://drive.google.com/file/d/14bRtn-lsl4itscxhgUtw_zJ4Lc5AFiZG/view"><img
                            src="assets/Employee_Tracker.PNG" class="card-img-top" alt="Employee Tracker" /></a>
                        <div class="card-body">
                            <h5 class="card-title">MySQL Employee Tracker</h5>
                            <p class="card-text">This project is a MySQL database program designed to allow a manager to edit their employee database through the terminal console.<a target="_blank"
